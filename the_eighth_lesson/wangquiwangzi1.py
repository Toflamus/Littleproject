...
def get_input():#返回值已经处理好了
    ...
    rule = input('they use tiebreak or not?if yes input 1 if not input 0')                                                                                                                                                                                                                                                                                                                                                                                                                                                                0')
    try:
        assert rule == '1' or '0'
    except:
...
def main():
    ...
    bigscore_ls = []
    setscore_dic = {}
    bigscore_ls,setscore_dic = semmatch(pro1,name2,pro2,setnum,rule)
    printoutput(name1,name2,bigscore_ls,setscore_dic)

main() 
#def decsemround(pro1,pro2):#决胜局
#     score1,score2 = 0,0
#     int(score1)
#     int(score2)
#     serving = True
